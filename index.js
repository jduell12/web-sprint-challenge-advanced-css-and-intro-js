...
function addArtist(objectInfo, array) {
  return array.push(objectInfo);
}
...
function lotsOfArt(array) {
  let newA = array.filter((artist) => artist.paintings > 100);
  return newA;
}
...
function getHTML(array) {
  for (let i = 0; i < array.length; i++) {
    ...
    console.log(`    <img src="./assets/${array[i].name}.jpg"/>`);
    console.log("</div>");
